...
import static com.hc.gear.HeroConstants.BEAR_WARRIOR;
...
import static com.hc.gear.HeroConstants.FALLEN_DOMINION;
...
import static com.hc.gear.HeroConstants.SHALLOWS_KEEPER;
import static com.hc.gear.HeroConstants.SNIPER;
import static com.hc.gear.HeroConstants.SWORDMASTER;
...
import static com.hc.gear.HeroConstants.WAR_CHIEF;
...
public class AbstractHeroTest extends AbstractEquipmentTest {
    ...
    protected final AbstractHero bearWarrior;
    ...
    protected final AbstractHero fallenDominion;
    ...
    protected final AbstractHero shallowsKeeper;
    protected final AbstractHero sniper;
    protected final AbstractHero swordmaster;
    ...
    protected final AbstractHero warChief;
    ...
    public AbstractHeroTest() {
        ...
        bearWarrior = getHeroes().get(BEAR_WARRIOR);
        ...
        fallenDominion = getHeroes().get(FALLEN_DOMINION);
        ...
        shallowsKeeper = getHeroes().get(SHALLOWS_KEEPER);
        sniper = getHeroes().get(SNIPER);
        swordmaster = getHeroes().get(SWORDMASTER);
        ...
        warChief = getHeroes().get(WAR_CHIEF);
